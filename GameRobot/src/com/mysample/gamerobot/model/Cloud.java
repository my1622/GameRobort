...
public class Cloud {
	...
	public void update(float delta) {
		...
		/*
		 * Matrix matrix = new Matrix(); matrix.setTranslate(100, 100);
		 * //设置图片的旋转中心，即绕（X,Y）这点进行中心旋转 matrix.preRotate(30,
		 * (float)gameImage.getWidth()/2, (float)gameImage.getHeight()/2);
		 * //要旋转的角度
		 */
